        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <select name="method">
                    ...
                    <option value="cash on delivary">paytm</option>
                </select>
            </div>
            <div class="inputBox">
                <span>address line 01 :</span>
                <input type="number" min="0" name="flat" require placeholder="e.g. flat no.">
            </div>
            <div class="inputBox">
                <span>address line 01 :</span>
                <input type="text" name="street" require placeholder="e.g. street name">
            </div>
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" require placeholder="e.g. dhaka">
            </div>
            <div class="inputBox">
                <span>country :</span>
                <input type="text" name="country" require placeholder="e.g. bangladesh">
            </div>
        </div>
