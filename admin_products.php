...
?>
    ...
    <section class="add-products">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <h3>add product</h3>
            <input type="text" name="name" class="box" placeholder="enter prouct name" required>
            <input type="number" min="0" name="price" class="box" placeholder="enter prouct price" required>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            ?>
            <div class="box">
                <img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="ggg">
